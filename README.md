...
```javascript
import extblas from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base@v0.2.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base@v0.2.0-deno/mod.js';
